        ...
        <div style={{ maxWidth: '600px' }}>
          <div style={{ marginBottom: '32px' }}>
            ...
            <div className="process-card">
              <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
                <div>
                  <div style={{ fontWeight: 500, marginBottom: '4px' }}>开机启动</div>
            ...
            <div className="process-card">
              <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
                <div>
                  <div style={{ fontWeight: 500, marginBottom: '4px' }}>最小化到托盘</div>
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <div className="process-card">
              <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
                <div>
                  <div style={{ fontWeight: 500, marginBottom: '4px' }}>路径包含子目录</div>
            ...
            <div className="process-card">
              <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
                <div>
                  <div style={{ fontWeight: 500, marginBottom: '4px' }}>显示系统进程</div>
            ...
            <div className="process-card">
              <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
                <div>
                  ...
                  <div className="text-muted" style={{ fontSize: '12px' }}>结束进程前显示确认对话框</div>
                </div>
                <input type="checkbox" defaultChecked style={{ width: '20px', height: '20px' }} />
              </label>
            </div>
            <div className="process-card">
              <label style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}>
                <div>
                  ...
                  <div className="text-muted" style={{ fontSize: '12px' }}>防止误操作结束系统关键进程</div>
                </div>
                <input type="checkbox" defaultChecked style={{ width: '20px', height: '20px' }} />
              </label>
            </div>
